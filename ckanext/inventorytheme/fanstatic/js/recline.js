    ...
    <form class="form-stacked"> \
      <div class="clearfix"> \
        <div class="form-group"> \
          ...
          <div class="input editor-type" aria-label="Graph Type"> \
        ...
        <div class="form-group"> \
          ...
          <div class="input editor-group" aria-label="Group Column (Axis 1)"> \
  ...
  templateSeriesEditor: ' \
    <div class="editor-series js-series-{{seriesIndex}}"> \
      <div class="form-group"> \
        ...
        <div class="input"> \
          <select id="form-field-{{seriesName}}" class="form-control" aria-label="Series {{seriesName}} (Axis 2)"> \
          {{#fields}} \
          <option value="{{id}}">{{label}}</option> \
          {{/fields}} \
          </select> \
      ...
      <div class="clearfix"> \
        ...
        <div class="editor-field-type-latlon"> \
          ...
          <div class="input editor-lat-field"> \
            <select id="form-field-lat-field" class="form-control" aria-label="Latitude field"> \
            <option value=""></option> \
            {{#fields}} \
            <option value="{{id}}">{{label}}</option> \
            {{/fields}} \
          ...
          <div class="input editor-lon-field"> \
            <select id="form-field-lon-field" class="form-control" aria-label="Longitude field"> \
            <option value=""></option> \
            {{#fields}} \
            <option value="{{id}}">{{label}}</option> \
            {{/fields}} \
...
my.MultiView = Backbone.View.extend({
  ...
  <div class="recline-data-explorer"> \
    ...
    <div class="header clearfix"> \
      <div class="navigation"> \
        ...
        {{#views}} \
        <button href="#{{id}}" data-view="{{id}}" class="btn btn-default" tabindex="1">{{label}}</button> \
        {{/views}} \
        </div> \
      </div> \
      ...
      <div class="menu-right"> \
        <div class="btn-group" data-toggle="buttons-checkbox"> \
          {{#sidebarViews}} \
          <button href="#" data-action="{{id}}" class="btn btn-default" tabindex="1">{{label}}</button> \
          {{/sidebarViews}} \
        </div> \
      </div> \
  ...
  notify: function(flash) {
    ...
    if (tmplData.loader) {
      ...
      _template = ' \
        <div class="alert alert-{{category}} fade in" data-alert="alert"><a class="close" data-dismiss="alert" href="#" aria-label="Close">×</a> \
          {{message}} \
        </div>';
    }
...
my.ValueFilter = Backbone.View.extend({
  ...
  template: ' \
    <div class="filters"> \
      <h3>Filters</h3> \
      <button class="btn js-add-filter add-filter" tabindex="2">Add filter</button> \
      <form class="form-stacked js-add" style="display: none;"> \
        <fieldset> \
          <label>Field</label> \
